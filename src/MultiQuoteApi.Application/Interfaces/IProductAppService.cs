...
namespace MultiQuoteApi.Application.Interfaces
{
    public interface IProductAppService
    {
        ...
        Task<IEnumerable<InsurancePlanCoverageModel>?> GetInsurancePlanCoverageLimitsAsync(int productId, int insurancePlanId, int profileId, RecordStatusEnum recordStatus);
    }
}
